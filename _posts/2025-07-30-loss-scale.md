...
![](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/loss_scale.png "")
# 了解loss scale
## DynamicGradScaler
初始化`initial_scale`为512. 目前llama 系列的为 `DynamiGradScaler`。

![](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/dynamic_grad.png "")
解读一下参数含义
...
![](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/grad_scale.png "")
### Grad unscale
optimizer.step的时候, graidents 除以scale.

![](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/grad_unscale.png "")
### loss scale 更新
optimizer.step的时候，gradient unscale 之后更新loss scale。

![](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/update_loss_scale.png "")
...
![](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/reduce_loss.png "")
...
![loss scale64, bucket 4: linear_qkv+linear_proj+mlp](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/grad_4.png "loss scale64, bucket 4: linear_qkv+linear_proj+mlp")
![loss scale 64, bucket7: linear_qkv+mlp](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/grad_7.png "loss scale 64, bucket7: linear_qkv+mlp")
同时，我也采集了`loss scale 512`分别在700， 800， 900的gradient数据。

![loss scale512, bucket 4: linear_qkv+linear_proj+mlp](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/loss_scale_grad_4.png "loss scale512, bucket 4: linear_qkv+linear_proj+mlp")
![loss scale512, bucket 7: linear_qkv+linear_proj+mlp](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/loss_scale_grad_7.png "loss scale512, bucket 7: linear_qkv+linear_proj+mlp")
图画的丑。。费眼观察到：loss scale512 在700/800/900 iteration的时候，数值域基本都是稳定在[-0.02, 0.02]附近。数值分布是稳定的，没有像loss scale 64，数值波动较大。

我们换一个更直观的对比方式：

![*PU loss scale 64 gradient 趋势图](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/loss_scale_64_grad.gif  "loss scale 64 gradient 趋势图")
![*PU loss scale 512 gradient 趋势图](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/loss_scale_512_grad.gif "loss scale 512 gradient 趋势图")
可以发现从iteration 100的时候，gradient分布就太对劲了，loss scale 64更加尖锐。

![GPU: loss scale 64 gradient 趋势图](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/gpu_loss_scale_64.gif "GPU: loss scale 64 gradient 趋势图")
![*PU: loss scale 64 gradient 趋势图](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/*pu_loss_scale_64.gif "*PU: loss scale 64 gradient 趋势图")
...
![gpu](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/1_2_4_gpu.png  "gpu")
![*PU](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/1_2_4_*pu.png "*PU")
我们再看一下GPU和*PU 主要module 梯度对比图：

||GPU|*PU|
|-|-|-|
|embedding梯度|![](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/gpu_embedding_grad.png "")|![](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/*pu_embedding_grad.png "")|
|embedding权重|![](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/gpu_embedding_weight.png "")|![](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/*pu_embedding_weight.png  "")|
|finallayer norm权重|![](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/gpu_final_layer_norm_grad.png "")一次分布漂移，分布变化连续缓慢|![](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/*pu_final_layer_norm_grad.png  "")四次分布漂移，明显的非连续变化|
|第一层输入layer norm梯度|![](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/gpu_layer0_layer_norm_grad.png "")|![](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/*pu_layer0_layer_norm_grad.png "")|
|第一次FFN输出梯度|![](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/gpu_layer0_ffn_grad.png "")|![](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/*pu_layer0_ffn_grad.png "")|
|输出层梯度|![](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/gpu_layer0_out_grad.png "")|![](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/*pu_layer0_out_grad.png "")|
|FFN up proj梯度|![](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/gpu_ffn_up_proj_grad.png "")FFN的up project，每层梯度都有outlier，逐层传递|![](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/*pu_ffn_up_proj_grad.png "")FFN的up project，每层梯度都没有outlier|

另外输出层的梯度存在较大差异：

DP越小，grad norm越大，并相差数量级

![](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/1_2_4_*pu.png  "")
# 单卡数值分析
分别解析了*PU和gpu的checkpoint，并做了数值分析图。单卡1层 *PU gpu比较 

|word_embeddings.weight|![]( "")|
|-|-|
|self_attention.linear_qkv.weight|![](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/self_attention.linear_qkv.weight.png "")|
|self_attention.linear_qkv.layer_norm_weight|![](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/self_attention.linear_qkv.layer_norm_weight "")|
|self_attention.linear_proj.weight|![](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/self_attention.linear_qkv.layer_norm_weight "")|
|mlp.lineaer_fc2.weight|![](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/mlp.lineaer_fc2.weight "")|
|mlp.linear_fc1.weight|![](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/mlp.linear_fc1.weight "")|
|mlp.linear_fc1.layer_norm_weight|![](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/mlp.linear_fc1.layer_norm_weight "")|
|final_layernorm.weight|![](https://raw.githubusercontent.com/sherry-1001/sherry-1001.github.io/master/_images/final_layernorm.weight "")|
